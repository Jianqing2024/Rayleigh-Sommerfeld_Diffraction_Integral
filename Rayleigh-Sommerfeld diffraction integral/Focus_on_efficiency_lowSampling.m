function [Efficiency,fwhm]=Focus_on_efficiency_lowSampling(E1,X1,Y1,E0,lambda,Focus_position,fwmhCheckPoint,fwmhCheckRadius,Sampling)
...
U1=RSarray(E1,lambda,X1,Y1,XX,YY,Focus_position);
