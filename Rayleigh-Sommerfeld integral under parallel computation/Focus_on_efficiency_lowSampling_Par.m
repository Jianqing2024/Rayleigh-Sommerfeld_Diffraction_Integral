function [Efficiency,fwhm]=Focus_on_efficiency_lowSampling_Par(E1,X1,Y1,E0,lambda,Focus_position,fwmhCheckPoint,fwmhCheckRadius,Sampling)
...
U=RSradial(E1,lambda,X1,Y1,xx,Focus_position);
fwhm = FWHM(xx, U);
...
U1=RSarray_Par(E1,lambda,X1,Y1,XX,YY,Focus_position);
